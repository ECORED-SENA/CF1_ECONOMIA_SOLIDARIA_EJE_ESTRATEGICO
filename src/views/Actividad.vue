  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Clasificación de los sectores económicos y el sector solidario en Colombia
        p.mb-4 Apropiar el conocimiento en la clasificación de los sectores económicos
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Valores y principios de las organizaciones de economía solidaria
        p.mb-4 Apropiar el conocimiento en la identificación de los valores y principios que regulan las actividades de economía solidaria
        .tarjeta.tarjeta--azul.p-3
          .row.justify-content-around.align-items-center            
            .col-sm.mb-3.mb-sm-0
